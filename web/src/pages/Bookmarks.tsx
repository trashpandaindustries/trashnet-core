...
function BookmarkCard({ bookmark, onDelete, onTogglePin }: { bookmark: any, onDelete: (id:string)=>void, onTogglePin: (id:string, show:boolean)=>void }) {
  ...
  return (
    <div className="bg-slate-800/80 border border-slate-700/80 rounded-xl hover:border-slate-600 transition-colors group flex flex-col h-64 relative focus-within:z-30 hover:z-30">
